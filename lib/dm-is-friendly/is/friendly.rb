    ...
    module Friendly
      ...
      class FriendlyConfig
        ...
        def initialize(klazz, opts)
          ...
          @friendship_foreign_key = DataMapper::Inflection.foreign_key(@reference_model.name).to_sym
          @friend_foreign_key     = DataMapper::Inflection.foreign_key(@friendship_class_name).to_sym
